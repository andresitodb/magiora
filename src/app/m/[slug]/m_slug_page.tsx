        ...
        <PublicProfileTabs
          ...
          about={
            <div className="space-y-8 md:space-y-10">
              ...
              {/* DEMO REEL & VIDEOS — now embedded inside About */}
              {hasAnyVideo && (
              ...
              {/* Projects this person owns or is credited on */}
          ...
          contact={
            <div className="space-y-8">
              ...
              {(rep.agency || rep.manager || rep.agent) && (
                <div>
              ...
              {!profile.contact_email && !profile.website_url && Object.values(social).filter((v) => v && (v as string).trim()).length === 0 && !rep.agency && (
                <p className="font-serif italic text-center py-12" style={{ color: accent.textMuted }}>
